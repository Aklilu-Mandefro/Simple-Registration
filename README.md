...
1. Copy the folder 'Simple Registration' into a web root directory:<br>
          A. if you use Xammp Server, put the folder 'Simple Registration' into Xampp/htdocs directory.<br>
